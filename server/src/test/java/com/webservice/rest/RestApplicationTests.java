...
public class RestApplicationTests 
{
    ...
    public void  showPatientInformationTest(){
        Patient patient =patientController.showPatientInformation(3);
        assertEquals(patient.getName(),"Srijith");
    }

    @Test
    public void showDoctorInformationTest(){
        Doctor doc = doctorController.getDoctorInfo("Sindhu"); 
        assertEquals(doc.getField(),"Cardiologist");
    ...
    public void savePatientInformation(){
        Patient patient = new Patient(1001, "hello", 30, "Sindhu",LocalDate.now(), "male", "xyz");
